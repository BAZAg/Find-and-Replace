          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="type" id="input-type" class="form-control">
                ...
                <?php } ?>
                <?php if ($type == 'radio_image') { ?>
                <option value="radio_image" selected="selected"><?php echo $text_radio_image; ?></option>
                <?php } else { ?>
                <option value="radio_image"><?php echo $text_radio_image; ?></option>
                <?php } ?>
...
$('select[name=\'type\']').on('change', function() {
	if (this.value == 'select' || this.value == 'radio' || this.value == 'radio_image' || this.value == 'checkbox' || this.value == 'image') {
		$('#option-value').show();
	} else {
		$('#option-value').hide();
	}
