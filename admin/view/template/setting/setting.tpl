        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-peoples"><?php echo $entry_peoples; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_peoples" placeholder="<?php echo $entry_peoples; ?>" value="<?php echo $config_peoples; ?>" id="input-peoples" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-post-address"><?php echo $entry_post_address; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_post_address" placeholder="<?php echo $config_post_address; ?>" value="<?php echo $config_post_address; ?>" id="input-post-address" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-map-code"><?php echo $entry_map_code; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_map_code" rows="5" placeholder="<?php echo $entry_map_code; ?>" id="input-map-code" class="form-control"><?php echo $config_map_code; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-gerb"><?php echo $entry_gerb; ?></label>
                <div class="col-sm-10"><a href="" id="thumb-gerb" data-toggle="image" class="img-thumbnail"><img src="<?php echo $gerb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_gerb" value="<?php echo $config_gerb; ?>" id="input-gerb" />
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-second-telephone"><?php echo $entry_second_telephone; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_second_telephone" value="<?php echo $config_second_telephone; ?>" placeholder="<?php echo $entry_second_telephone; ?>" id="input-second-telephone" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-tg"><?php echo $entry_tg; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_tg" value="<?php echo $config_tg; ?>" placeholder="<?php echo $entry_tg; ?>" id="input-tg" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-whatsapp"><?php echo $entry_whatsapp; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_whatsapp" value="<?php echo $config_whatsapp; ?>" placeholder="<?php echo $entry_whatsapp; ?>" id="input-whatsapp" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-viber"><?php echo $entry_viber; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_viber" value="<?php echo $config_viber; ?>" placeholder="<?php echo $entry_viber; ?>" id="input-viber" class="form-control" />
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-local">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-region-name"><?php echo $entry_region_name; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_region_name" value="<?php echo $config_region_name; ?>" placeholder="<?php echo $entry_region_name; ?>" id="input-region-name" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-region-name-2"><?php echo $entry_region_name_2; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_region_name_2" value="<?php echo $config_region_name_2; ?>" placeholder="<?php echo $entry_region_name_2; ?>" id="input-region-name-2" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-region-name-3"><?php echo $entry_region_name_3; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_region_name_3" value="<?php echo $config_region_name_3; ?>" placeholder="<?php echo $entry_region_name_3; ?>" id="input-region-name-3" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-city-name"><?php echo $entry_city_name; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_city_name" value="<?php echo $config_city_name; ?>" placeholder="<?php echo $entry_city_name; ?>" id="input-city-name" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-city-name-2"><?php echo $entry_city_name_2; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_city_name_2" value="<?php echo $config_city_name_2; ?>" placeholder="<?php echo $entry_city_name_2; ?>" id="input-city-name-2" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-city-name-3"><?php echo $entry_city_name_3; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_city_name_3" value="<?php echo $config_city_name_3; ?>" placeholder="<?php echo $entry_city_name_3; ?>" id="input-city-name-3" class="form-control" />
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-contacts">
              <fieldset>
                <legend><?php echo $entry_image; ?></legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-contact-image"><?php echo $entry_image; ?></label>
                  <div class="col-sm-10"><a href="" id="thumb-contact-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $contact_image; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_contact_image" value="<?php echo $config_contact_image; ?>" id="input-contact-image" />
                </div>
                </div>
              </fieldset>
              <fieldset>
                <legend><?php echo $text_information; ?></legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-company-name"><?php echo $entry_company_name; ?></label>
                  <div class="col-sm-10">
                    <input name="config_company_name" placeholder="<?php echo $entry_company_name; ?>" value="<?php echo $config_company_name; ?>" id="input-company-name" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-company-inn"><?php echo $entry_company_inn; ?></label>
                  <div class="col-sm-10">
                    <input name="config_company_inn" placeholder="<?php echo $entry_company_inn; ?>" value="<?php echo $config_company_inn; ?>" id="input-company-inn" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-company-ogrn"><?php echo $entry_company_ogrn; ?></label>
                  <div class="col-sm-10">
                    <input name="config_company_ogrn" placeholder="<?php echo $entry_company_ogrn; ?>" value="<?php echo $config_company_ogrn; ?>" id="input-company-ogrn" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-company-rs"><?php echo $entry_company_rs; ?></label>
                  <div class="col-sm-10">
                    <input name="config_company_rs" placeholder="<?php echo $entry_company_rs; ?>" value="<?php echo $config_company_rs; ?>" id="input-company-rs" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-company-bank"><?php echo $entry_company_bank; ?></label>
                  <div class="col-sm-10">
                    <input name="config_company_bank" placeholder="<?php echo $entry_company_bank; ?>" value="<?php echo $config_company_bank; ?>" id="input-company-bank" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-company-bik"><?php echo $entry_company_bik; ?></label>
                  <div class="col-sm-10">
                    <input name="config_company_bik" placeholder="<?php echo $entry_company_bik; ?>" value="<?php echo $config_company_bik; ?>" id="input-company-bik" class="form-control" />
                  </div>
                </div>
              </fieldset>
              <fieldset>
                <legend><?php echo $text_extra; ?></legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-contact-h"><?php echo $entry_h; ?></label>
                  <div class="col-sm-10">
                    <input name="config_contact_h" placeholder="<?php echo $entry_h; ?>" value="<?php echo $config_contact_h; ?>" id="input-contact-h" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="textarea-about-us"><?php echo $entry_about_us; ?></label>
                  <div class="col-sm-10">
                    <textarea name="config_about_us" placeholder="<?php echo $entry_about_us; ?>" rows="5" id="textarea-about-us" class="form-control"><?php echo $config_about_us; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-contact-block"><?php echo $entry_contact_block; ?></label>
                  <div class="col-sm-10">
                    <input name="config_contact_block" placeholder="<?php echo $entry_contact_block; ?>" value="<?php echo $config_contact_block; ?>" id="input-contact-block" class="form-control" />
                  </div>
                </div>
              </fieldset>
            </div>
