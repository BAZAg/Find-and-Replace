...
class ControllerCatalogInformation extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_extra_bottom'] = $this->language->get('entry_extra_bottom');
		$data['entry_sort_order'] = $this->language->get('entry_sort_order');
		$data['entry_status'] = $this->language->get('entry_status');
		$data['entry_layout'] = $this->language->get('entry_layout');
		$data['entry_ex_block'] = $this->language->get('entry_ex_block');
		$data['entry_image'] = $this->language->get('entry_image');

		$data['help_keyword'] = $this->language->get('help_keyword');
		$data['help_bottom'] = $this->language->get('help_bottom');
		$data['help_extra_bottom'] = $this->language->get('help_extra_bottom');
		...
		if (isset($this->request->post['extra_bottom'])) {
			$data['extra_bottom'] = $this->request->post['extra_bottom'];
		} elseif (!empty($information_info)) {
			$data['extra_bottom'] = $information_info['extra_bottom'];
		} else {
			$data['extra_bottom'] = 0;
		}
		...
		if (isset($this->request->post['ex_block'])) {
			$data['ex_block'] = $this->request->post['ex_block'];
		} elseif (!empty($information_info)) {
			$data['ex_block'] = $information_info['ex_block'];
		} else {
			$data['ex_block'] = '';
		}
