...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_tg'] = $this->language->get('entry_tg');
		...
		$data['entry_company_ogrn'] = $this->language->get('entry_company_ogrn');
		...
		$data['entry_h'] = $this->language->get('entry_h');
		$data['entry_about_us'] = $this->language->get('entry_about_us');
		$data['entry_contact_block'] = $this->language->get('entry_contact_block');
		...
		$data['entry_second_telephone'] = $this->language->get('entry_second_telephone');
		...
		//HaterStudio
		$data['entry_peoples'] = $this->language->get('entry_peoples');
		$data['entry_city_name'] = $this->language->get('entry_city_name');
		$data['entry_city_name_2'] = $this->language->get('entry_city_name_2');
		$data['entry_city_name_3'] = $this->language->get('entry_city_name_3');
		$data['entry_region_name'] = $this->language->get('entry_region_name');
		$data['entry_region_name_2'] = $this->language->get('entry_region_name_2');
		$data['entry_region_name_3'] = $this->language->get('entry_region_name_3');
		$data['entry_gerb'] = $this->language->get('entry_gerb');
		$data['entry_post_address'] = $this->language->get('entry_post_address');
		$data['entry_map_code'] = $this->language->get('entry_map_code');
		...
		if (isset($this->request->post['config_peoples'])) {
			$data['config_peoples'] = $this->request->post['config_peoples'];
		} else {
			$data['config_peoples'] = $this->config->get('config_peoples');
		}

		if (isset($this->request->post['config_post_address'])) {
			$data['config_post_address'] = $this->request->post['config_post_address'];
		} else {
			$data['config_post_address'] = $this->config->get('config_post_address');
		}

		if (isset($this->request->post['config_map_code'])) {
			$data['config_map_code'] = $this->request->post['config_map_code'];
		} else {
			$data['config_map_code'] = $this->config->get('config_map_code');
		}

		if (isset($this->request->post['config_gerb'])) {
			$data['config_gerb'] = $this->request->post['config_gerb'];
		} else {
			$data['config_gerb'] = $this->config->get('config_gerb');
		}

		if (isset($this->request->post['config_contact_image'])) {
			$data['config_contact_image'] = $this->request->post['config_contact_image'];
		} else {
			$data['config_contact_image'] = $this->config->get('config_contact_image');
		}
		...
		if (isset($this->request->post['config_company_name'])) {
			$data['config_company_name'] = $this->request->post['config_company_name'];
		} else {
			$data['config_company_name'] = $this->config->get('config_company_name');
		}

		if (isset($this->request->post['config_company_inn'])) {
			$data['config_company_inn'] = $this->request->post['config_company_inn'];
		} else {
			$data['config_company_inn'] = $this->config->get('config_company_inn');
		}

		if (isset($this->request->post['config_company_ogrn'])) {
			$data['config_company_ogrn'] = $this->request->post['config_company_ogrn'];
		} else {
			$data['config_company_ogrn'] = $this->config->get('config_company_ogrn');
		}

		if (isset($this->request->post['config_company_rs'])) {
			$data['config_company_rs'] = $this->request->post['config_company_rs'];
		} else {
			$data['config_company_rs'] = $this->config->get('config_company_rs');
		}

		if (isset($this->request->post['config_company_bank'])) {
			$data['config_company_bank'] = $this->request->post['config_company_bank'];
		} else {
			$data['config_company_bank'] = $this->config->get('config_company_bank');
		}

		if (isset($this->request->post['config_company_bik'])) {
			$data['config_company_bik'] = $this->request->post['config_company_bik'];
		} else {
			$data['config_company_bik'] = $this->config->get('config_company_bik');
		}

		if (isset($this->request->post['config_contact_h'])) {
			$data['config_contact_h'] = $this->request->post['config_contact_h'];
		} else {
			$data['config_contact_h'] = $this->config->get('config_contact_h');
		}

		if (isset($this->request->post['config_about_us'])) {
			$data['config_about_us'] = $this->request->post['config_about_us'];
		} else {
			$data['config_about_us'] = $this->config->get('config_about_us');
		}

		if (isset($this->request->post['config_contact_block'])) {
			$data['config_contact_block'] = $this->request->post['config_contact_block'];
		} else {
			$data['config_contact_block'] = $this->config->get('config_contact_block');
		}

		if (isset($this->request->post['config_gerb']) && is_file(DIR_IMAGE . $this->request->post['config_gerb'])) {
			$data['gerb'] = $this->model_tool_image->resize($this->request->post['config_gerb'], 100, 100);
		} elseif ($this->config->get('config_gerb') && is_file(DIR_IMAGE . $this->config->get('config_gerb'))) {
		...
		if (isset($this->request->post['config_contact_image']) && is_file(DIR_IMAGE . $this->request->post['config_contact_image'])) {
			$data['contact_image'] = $this->model_tool_image->resize($this->request->post['config_contact_image'], 100, 100);
		} elseif ($this->config->get('config_contact_image') && is_file(DIR_IMAGE . $this->config->get('config_contact_image'))) {
			$data['contact_image'] = $this->model_tool_image->resize($this->config->get('config_contact_image'), 100, 100);
		} else {
			$data['contact_image'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}

		if (isset($this->request->post['config_city_name'])) {
			$data['config_city_name'] = $this->request->post['config_city_name'];
		} else {
			$data['config_city_name'] = $this->config->get('config_city_name');
		}

		if (isset($this->request->post['config_city_name_2'])) {
			$data['config_city_name_2'] = $this->request->post['config_city_name_2'];
		} else {
			$data['config_city_name_2'] = $this->config->get('config_city_name_2');
		}

		if (isset($this->request->post['config_city_name_3'])) {
			$data['config_city_name_3'] = $this->request->post['config_city_name_3'];
		} else {
			$data['config_city_name_3'] = $this->config->get('config_city_name_3');
		}

		if (isset($this->request->post['config_region_name'])) {
			$data['config_region_name'] = $this->request->post['config_region_name'];
		} else {
			$data['config_region_name'] = $this->config->get('config_region_name');
		}

		if (isset($this->request->post['config_region_name_2'])) {
			$data['config_region_name_2'] = $this->request->post['config_region_name_2'];
		} else {
			$data['config_region_name_2'] = $this->config->get('config_region_name_2');
		}

		if (isset($this->request->post['config_region_name_3'])) {
			$data['config_region_name_3'] = $this->request->post['config_region_name_3'];
		} else {
			$data['config_region_name_3'] = $this->config->get('config_region_name_3');
		}
