        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-extra-bottom"><span data-toggle="tooltip" title="<?php echo $help_extra_bottom; ?>"><?php echo $entry_extra_bottom; ?></span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($extra_bottom) { ?>
                      <input type="checkbox" name="extra_bottom" value="1" checked="checked" id="input-extra-bottom" />
                      <?php } else { ?>
                      <input type="checkbox" name="extra_bottom" value="1" id="input-extra-bottom" />
                      <?php } ?>
                      &nbsp; </label>
                  </div>
                </div>
            ...
            <div class="tab-pane" id="tab-design">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-ex-block"><?php echo $entry_image; ?></label>
                <div class="col-sm-10">
                ...
                <label class="col-sm-2 control-label" for="input-ex-block"><?php echo $entry_ex_block; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="ex_block" value="<?php echo $ex_block; ?>" placeholder="<?php echo $entry_ex_block; ?>" id="input-ex-block" class="form-control" />
                </div>
              </div>
            </div>
          </div>
