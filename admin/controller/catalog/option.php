...
class ControllerCatalogOption extends Controller {
	...
	protected function getForm() {
		...
		$data['text_radio_image'] = $this->language->get('text_radio_image');
	...
	protected function validateForm() {
		...
		if (($this->request->post['type'] == 'select' || $this->request->post['type'] == 'radio' || $this->request->post['type'] == 'checkbox' || $this->request->post['type'] == 'radio_image') && !isset($this->request->post['option_value'])) {
