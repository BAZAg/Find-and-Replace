...
class ControllerSettingStore extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_setting_store->setProductsAndCategoryToStore($store_id);
	...
	protected function getForm() {
		...
		} elseif(!empty($store_info['config_peoples'])) {
			$data['config_peoples'] = $store_info['config_peoples'];
		} else {
			$data['config_peoples'] = '';
		}
		...
		} elseif(!empty($store_info['config_post_address'])) {
			$data['config_post_address'] = $store_info['config_post_address'];
		} else {
			$data['config_post_address'] = '';
		}

		if (isset($this->request->post['config_map_code'])) {
			$data['config_map_code'] = $this->request->post['config_map_code'];
		} elseif(!empty($store_info['config_map_code'])) {
			$data['config_map_code'] = $store_info['config_map_code'];
		} else {
			$data['config_map_code'] = '';
		}

		if (isset($this->request->post['config_gerb'])) {
			$data['config_gerb'] = $this->request->post['config_gerb'];
		} elseif(!empty($store_info['config_gerb'])) {
			$data['config_gerb'] = $store_info['config_gerb'];
		} else {
			$data['config_gerb'] = '';
		}
		...
		} elseif (!empty($store_info['config_gerb']) && is_file(DIR_IMAGE . $store_info['config_gerb'])) {
			$data['gerb'] = $this->model_tool_image->resize($store_info['config_gerb'], 100, 100);
		} else {
		...
		} elseif(!empty($store_info['config_city_name'])) {
			$data['config_city_name'] = $store_info['config_city_name'];
		} else {
			$data['config_city_name'] = '';
		}

		if (isset($this->request->post['config_city_name_2'])) {
			$data['config_city_name_2'] = $this->request->post['config_city_name_2'];
		} elseif(!empty($store_info['config_city_name_2'])) {
			$data['config_city_name_2'] = $store_info['config_city_name_2'];
		} else {
			$data['config_city_name_2'] = '';
		}

		if (isset($this->request->post['config_city_name_3'])) {
			$data['config_city_name_3'] = $this->request->post['config_city_name_3'];
		} elseif(!empty($store_info['config_city_name_3'])) {
			$data['config_city_name_3'] = $store_info['config_city_name_3'];
		} else {
			$data['config_city_name_3'] = '';
		}

		if (isset($this->request->post['config_region_name'])) {
			$data['config_region_name'] = $this->request->post['config_region_name'];
		} elseif(!empty($store_info['config_region_name'])) {
			$data['config_region_name'] = $store_info['config_region_name'];
		} else {
			$data['config_region_name'] = '';
		}

		if (isset($this->request->post['config_region_name_2'])) {
			$data['config_region_name_2'] = $this->request->post['config_region_name_2'];
		} elseif(!empty($store_info['config_region_name_2'])) {
			$data['config_region_name_2'] = $store_info['config_region_name_2'];
		} else {
			$data['config_region_name_2'] = '';
		}

		if (isset($this->request->post['config_region_name_3'])) {
			$data['config_region_name_3'] = $this->request->post['config_region_name_3'];
		} elseif(!empty($store_info['config_region_name_3'])) {
			$data['config_region_name_3'] = $store_info['config_region_name_3'];
		} else {
			$data['config_region_name_3'] = '';
		}
		...
		if (isset($this->request->post['config_second_telephone'])) {
			...
			$data['config_second_telephone'] = $store_info['config_second_telephone'];
		} else {
			$data['config_second_telephone'] = '';
		}
