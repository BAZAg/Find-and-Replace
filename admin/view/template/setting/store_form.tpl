          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_post_address" placeholder="<?php echo $entry_post_address; ?>" value="<?php echo $config_post_address; ?>" id="input-post-address" class="form-control" />
                </div>
              </div>
              <div class="form-group">
