        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-option<?php echo $option_row; ?>">
                      ...
                      <?php } ?>
                      <?php if ($product_option['type'] == 'select' || $product_option['type'] == 'radio' || $product_option['type'] == 'radio_image' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image') { ?>
                      <div class="table-responsive">
            ...
            <div class="tab-pane" id="tab-design">
              ...
              <fieldset>
                <legend><?php echo $text_block_0; ?></legend>
                <div class="form-group">
                  <div class="col-sm-2">
                    <a href="" id="thumb-image-block-0" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_block_0; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="image_block_0" value="<?php echo $image_block_0; ?>" id="input-image-block-0" />
                  </div>
                  <div class="col-sm-10">
                    <div class="form-group">
                    <label class="col-sm-3 control-label" for="input-block-0-h"><?php echo $entry_block_h; ?></label>
                      <div class="col-sm-9">
                        <input type="text" name="h_block_0" value="<?php echo $h_block_0; ?>" placeholder="<?php echo $entry_block_h; ?>" id="input-block-0-h" class="form-control" />
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label" for="input-block-0-html"><?php echo $entry_block_html; ?></label>
                      <div class="col-sm-9">
                        <textarea name="html_block_0" placeholder="<?php echo $entry_block_html; ?>" id="input-block-0-html" class="form-control summernote" ><?php echo $html_block_0; ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-block-1-text"><span data-toggle="tooltip" title="<?php echo $help_block_text; ?>"><?php echo $entry_block_text; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="block_1_text" value="<?php echo $block_1_text; ?>" placeholder="<?php echo $entry_block_text; ?>" id="input-block-1-text" class="form-control" />
                  </div>
                </div>
              </fieldset>
              <fieldset>
                ...
                <div class="form-group">
                  <div class="col-sm-2">
                    <a href="" id="thumb-image-block-2" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_block_2; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="image_block_2" value="<?php echo $image_block_2; ?>" id="input-image-block-2" />
                  </div>
                  <div class="col-sm-10">
                    <div class="form-group">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <div class="col-sm-2">
                    <div class="form-group">
                      <div class="col-sm-12">
                        <label class="control-label" for="thumb-image-block-3"><?php echo $text_image_block; ?></label>
                    ...
                    <div class="form-group">
                      <div class="col-sm-12">
                       <label class="control-label" for="thumb-background-block-3"><?php echo $text_background_block; ?></label>
                       <a href="" id="thumb-background-block-3" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_background_block_3; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="background_block_3" value="<?php echo $background_block_3; ?>" id="input-background-block-3" />
                     </div>
                    </div>
                  </div>
                  <div class="col-sm-10">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <textarea name="html_block_3" placeholder="<?php echo $entry_bloсk_html; ?>" id="input-block-3-html" class="form-control summernote" ><?php echo $html_block_3; ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <fieldset>
                <legend><?php echo $text_block_4; ?></legend>
                <div class="form-group">
                  <div class="col-sm-2">
                    <a href="" id="thumb-image-block-4" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_block_4; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="image_block_4" value="<?php echo $image_block_4; ?>" id="input-image-block-4" />
                  </div>
                  <div class="col-sm-10">
                    <div class="form-group">
                    <label class="col-sm-3 control-label" for="input-block-4-h"><?php echo $entry_block_h; ?></label>
                      <div class="col-sm-9">
                        <input type="text" name="h_block_4" value="<?php echo $h_block_4; ?>" placeholder="<?php echo $entry_block_h; ?>" id="input-block-4-h" class="form-control" />
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label" for="input-block-4-html"><?php echo $entry_block_html; ?></label>
                      <div class="col-sm-9">
                        <textarea name="html_block_4" placeholder="<?php echo $entry_block_html; ?>" id="input-block-4-html" class="form-control summernote" ><?php echo $html_block_4; ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <fieldset>
                <legend><?php echo $text_block_5; ?></legend>
                <div class="form-group">
                  <div class="col-sm-2">
                    <a href="" id="thumb-image-block-5" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_block_5; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="image_block_5" value="<?php echo $image_block_5; ?>" id="input-image-block-5" />
                  </div>
                  <div class="col-sm-10">
                    <div class="form-group">
                    <label class="col-sm-3 control-label" for="input-block-5-h"><?php echo $entry_block_h; ?></label>
                      <div class="col-sm-9">
                        <input type="text" name="h_block_5" value="<?php echo $h_block_5; ?>" placeholder="<?php echo $entry_block_h; ?>" id="input-block-5-h" class="form-control" />
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label" for="input-block-5-html"><?php echo $entry_block_html; ?></label>
                      <div class="col-sm-9">
                        <textarea name="html_block_5" placeholder="<?php echo $entry_block_html; ?>" id="input-block-5-html" class="form-control summernote" ><?php echo $html_block_5; ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <fieldset>
                <legend><?php echo $text_block_6; ?></legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-block-6-text"><span data-toggle="tooltip" title="<?php echo $help_block_text; ?>"><?php echo $entry_block_text; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="text_block_6" value="<?php echo $block_6_text; ?>" placeholder="<?php echo $entry_block_text; ?>" id="input-block-6-text" class="form-control" />
                  </div>
                </div>
              </fieldset>
            </div>
