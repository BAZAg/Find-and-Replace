...
class ControllerSaleOrder extends Controller {
	...
	public function getForm() {
		...
		if (!empty($order_info)) {
			...
			$data['payment_middlename'] = $order_info['payment_middlename'];
			...
			$data['shipping_middlename'] = $order_info['shipping_middlename'];
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['email'] = $order_info['email'] ? $order_info['email'] : $this->language->get('no_email');
			$data['telephone'] = $order_info['telephone'];
